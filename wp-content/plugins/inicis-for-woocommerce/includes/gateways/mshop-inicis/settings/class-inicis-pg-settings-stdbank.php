...
if ( ! class_exists( 'INICIS_PG_Settings_Stdbank' ) ) {
	class INICIS_PG_Settings_Stdbank extends INICIS_PG_Settings{
		protected $id = 'inicis_stdbank';
		public static function get_setting_fields() {
			return array(
				array(
					'type'     => 'Section',
					'title'    => '실시간 계좌이체 기본 설정',
					'elements' => array(
						array(
							'id'        => 'inicis_pg_inicis_stdbank_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '실시간 계좌이체',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdbank_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
							'default'   => '은행 계좌에서 바로 대금을 이체하여 결제합니다.',
							'tooltip'   => array(
								'title' => array(
						...
						array(
							'id'        => 'inicis_pg_inicis_stdbank_receipt',
				...
				array(
					...
					'elements' => array(
						array(
							'id'        => 'inicis_pg_inicis_stdbank_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdbank_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'inicis-for-woocommerce' ),
							'showIf'   => array( 'inicis_pg_inicis_stdbank_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
							...
							'tooltip'   => array(
								'title' => array(
									'content' => __( '실시간 계좌이체 결제건에 한해서, 결제후 주문접수가 완료된 경우 해당 주문의 상태를 지정하는 필수옵션입니다.', 'inicis-for-woocommerce' ),
								)
							)
						),
						array(
							'id'        => 'inicis_pg_inicis_stdbank_order_status_after_refund',
							...
							'tooltip'   => array(
								'title' => array(
									'content' => __( '실시간 계좌이체 결제건에 한해서, 사용자의 환불처리가 승인된 경우 해당 주문의 상태를 지정하는 필수옵션입니다.', 'inicis-for-woocommerce' ),
								)
							)
						),
						array(
							'id'        => 'inicis_pg_inicis_stdbank_possible_refund_status_for_mypage',
							...
							'tooltip'   => array(
								'title' => array(
									'content' => __( '실시간 계좌이체 결제건에 한해서, 사용자가 My-Account 메뉴에서 주문취소 요청을 할 수 있는 주문 상태를 지정합니다.', 'inicis-for-woocommerce' ),
								)
							)
						),
						array(
							'id'        => 'inicis_pg_inicis_stdbank_possible_refund_status_for_admin',
							...
							'tooltip'   => array(
								'title' => array(
									'content' => __( '실시간 계좌이체 결제건에 한해서, 관리자가 관리자 페이지 주문 상세 페이지에서 환불 처리를 할 수 있는 주문 상태를 지정합니다.', 'inicis-for-woocommerce' ),
								)
							)
						),
					)

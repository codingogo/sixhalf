...
if ( ! class_exists( 'INICIS_PG_Settings_Stdhpp' ) ) {
	class INICIS_PG_Settings_Stdhpp extends INICIS_PG_Settings{
		protected $id = 'inicis_stdhpp';
		static function get_setting_fields() {
			return array(
				array(
					'type'     => 'Section',
					'title'    => '휴대폰 소액결제 기본 설정',
					'elements' => array(
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '휴대폰 소액결제',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_hpp_method',
							'title'     => __( '상품 컨텐츠 구분', 'inicis-for-woocommerce' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => '2',
							'options'   => array(
				...
				array(
					...
					'elements' => array(
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'inicis-for-woocommerce' ),
							'showIf'   => array( 'inicis_pg_inicis_stdhpp_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_order_status_after_refund',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_possible_refund_status_for_mypage',
						...
						array(
							'id'        => 'inicis_pg_inicis_stdhpp_possible_refund_status_for_admin',

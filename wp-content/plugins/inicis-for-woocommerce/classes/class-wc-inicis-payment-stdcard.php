	...
	if ( ! class_exists( 'WC_Gateway_Inicis_Stdcard' ) ) {
		...
		class WC_Gateway_Inicis_Stdcard extends WC_Gateway_Inicis {
			public function __construct() {
				...
				$settings = inicis_pg_get_setting( 'stdcard' );
//				$this->init_settings();
            ...
            function thankyou_page( $order_id ) {
                echo __('<div id="inicis_thankyou_text"><p>신용카드로 결제되었습니다. 감사합니다.</p></div>', 'inicis_payment');
            }
		...
		if ( defined('DOING_AJAX') ) {
			$ajax_requests = array('payment_form_inicis_stdcard', 'refund_request_inicis_stdcard', 'repay_request_inicis_stdcard');
